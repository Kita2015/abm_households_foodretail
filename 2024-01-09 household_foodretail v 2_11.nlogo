...
to draft-alternative-shopping-list

  let unavailable-ingredient first shopping-list
  let alternative-shopping-list remove unavailable-ingredient diets-list
